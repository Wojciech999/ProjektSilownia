package com.example.projektsilownia.basictraining.secondStep.adapter;
...
public class SecondStepRecyclerViewAdapter extends RecyclerView.Adapter<SecondStepRecyclerViewAdapter.SecondStepRecyclerViewHolder> {

    Context context;
    ArrayList<GetTreningValueModel> getTreningValueModels;

    public SecondStepRecyclerViewAdapter(Context context, ArrayList<GetTreningValueModel> getTreningValueModels){
    ...
    @NonNull
    @Override
    public SecondStepRecyclerViewAdapter.SecondStepRecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SecondStepRecyclerViewAdapter.SecondStepRecyclerViewHolder holder, int position) {
